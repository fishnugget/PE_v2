...
<div class="row" style="padding-top:5px">
    ...
    <div class="rcol">
     <select name="FromPickupMonth" size="1" style="width: 50px; font-size: 14px !important;background-color:ffffff !important;">
                        ...
                        <select class="style6" name="FromPickupDay" size="1" style="width: 40px; font-size: 14px !important; background-color:ffffff !important;">
                          <option selected="">1 
                          </option><option>2 
                          </option><option>3 
                          </option><option>4 
                        ...
                        <select class="style6" name="FromPickupYear" size="1" style="width: 60px; font-size: 14px !important;background-color:ffffff !important;">
                          <option>2013</option>
...
<div class="row" style="padding-top:5px">
    ...
    <div class="rcol" style="font-size:14px"><select name="SenderShipperNumber" class="style6" style="width:165px;margin-top: 10px !important;	font-size: 14px !important;">
...
<div class="row">
    ...
    <div class="rcol" style="font-size:14px;"><input name="Log In" type="image" value="Track this package" src="/img/topbar/go_button.png" style="padding-top:5px;border: 0px;">
    </div>
</div>
